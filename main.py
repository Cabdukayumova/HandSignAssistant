...
#frame your image capturing area
    cv2.rectangle(frame, (400, 300), (600, 600), (0, 255, 0), 3)
    curr = prediction(pred_class)

#add some text to your frame
    cv2.putText(frame, "AI Hand Sign Assistant", (100, 50), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), lineType=cv2.LINE_AA)
